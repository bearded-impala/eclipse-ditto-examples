        ...
        try:
            ...
            operations = [
                ...
                ("Simulating External Service (Update Weather Data)", 
                 lambda: self.update_thing_property(self.vehicle_id, "features/weather/properties", weather_data)),
                ("Retrieving Digital Twin State", lambda: self.get_thing(self.vehicle_id)),
            ]
