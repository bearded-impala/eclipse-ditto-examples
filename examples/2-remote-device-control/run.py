        ...
        try:
            operations = [
                ...
                ("Updating Desired State (onOff)", 
                 lambda: self.update_thing_property(self.light_id, "features/onOff/properties/status/desired", True)),
                ("Retrieving Digital Twin State", lambda: self.get_thing(self.light_id)),
            ]
